...
// @version    		1.1.1
// @description  	Display tenths of seconds on the tagpro clock as well as outlines the score
...
tagpro.ready(function() {
    //if set to true, will display outline around score numbers, false will display it normally
    var showScoreStroke = true;
    //the number of seconds to begin displaying tenths of a second
    var startAt = 720; //Default is 720 = 12 min, set to whatever you like, if set to 0, no fractional seconds will be displayed
    ...
    tagpro.ui.timer = function(e,t,n,r)
    {
        ...
        if(startAt!=0 && parseInt(min)*60+milli/1000 <= startAt) //wait until there are startAt seconds left
        {
                ...
                e.textAlign="center",
                    e.fillStyle="rgba(255, 255, 255, 1)",
                        e.strokeStyle="#000000",
                            e.lineWidth=4,
                                e.font="bold 30pt Arial",
                                    e.strokeText(r,t.x,n.height-25),
                                        e.fillText(r,t.x,n.height-25),
